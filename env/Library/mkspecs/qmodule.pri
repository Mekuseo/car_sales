EXTRA_INCLUDEPATH += c:/users/mekus/desktop/stutern tasks/python workshops/car_sales/env\\Library\\include
EXTRA_LIBDIR += c:/users/mekus/desktop/stutern tasks/python workshops/car_sales/env\\Library\\lib
